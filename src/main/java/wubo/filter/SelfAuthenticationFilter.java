 ...
 * @since 3.0
 */
public class SelfAuthenticationFilter extends AbstractCasFilter {
    ...
    private String token;//排除的url路径访问token
    ...
    protected void initInternal(final FilterConfig filterConfig) throws ServletException {
        if (!isIgnoreInitConfiguration()) {
            ...
            String token = getPropertyFromInitParams(filterConfig, "token", null);
    ...
    public final void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain filterChain) throws IOException, ServletException {
        ...
        if(isInWhiteList  && FileNameUtil.encodeToFileName(token).equals(requesttoken)){
        	log.debug("请求wlist："+uri);
